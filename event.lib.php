...
namespace  {
	...
	class EventHttpConnection {
	    ...
	    public function getPeer(&$address, &$port) : void {}
	...
	class EventHttp {
		...
		public function setCallback(string $path, callable $cb, $arg = null): bool {}
		public function setDefaultCallback(callable $cb, $arg = null): void {}
	...
	class EventBuffer {
	    ...
	    public function search(string $what, int $start = -1, int $end = -1): int {}
	    public function searchEol(int $start = -1, int $eol_style = EventBuffer::EOL_ANY): int {}
	    public function pullup(int $size): ?string {}
	    public function write($fd, int $howmuch = -1): int {}
	    public function readFrom($fd, int $howmuch = -1): int {}
	    public function substr(int $start, int $length = -1): string {}
	}
	
	class EventBufferEvent {
	    public function __construct(EventBase $base, $socket = null, int $options = 0,
	        ?callable $readcb = null, ?callable $writecb = null, ?callable $eventcb = null, $arg = null) {}
	    public function free(): void {}
