...
class GeneratorController extends \fwe\console\Controller {
	 ...
	 * @param bool $isOver 是否覆盖
	 */
	public function actionCtrl(Generator $generator, string $model, string $class, string $search, ?string $path = null, string $base = Controller::class, ?string $title = null, bool $isTpl = false, bool $isOver = false) {
