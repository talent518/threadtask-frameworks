 ...
 * @method mixed scan($cursor, $MATCH = null, $pattern = null, $COUNT = null, $count = null) 迭代当前数据库中的键。 <https://redis.io/commands/scan>
 * 
 ...
 * @method mixed hscan($key, $cursor, $MATCH = null, $pattern = null, $COUNT = null, $count = null) 增量迭代哈希字段和关联值。 <https://redis.io/commands/hscan>
 ...
 * @method mixed sscan($key, $cursor, $MATCH = null, $pattern = null, $COUNT = null, $count = null) 增量迭代无序集合中的元素 <https://redis.io/commands/sscan>
 ...
 * @method mixed zscan($key, $cursor, $MATCH = null, $pattern = null, $COUNT = null, $count = null) 增量迭代有序集合中的元素（包括元素成员和元素分值） <https://redis.io/commands/zscan>
